...
const UserDashboard = () => {
  ...
  // Mock user data - replace with real data from Redux/API
  const user = {
    name: "John Doe",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div
        className={`fixed h-full inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
